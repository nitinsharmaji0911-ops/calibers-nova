  ...
  return (
    <section id="method" className="py-8 sm:py-14 px-3 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="rounded-[28px] sm:rounded-[36px] bg-gradient-to-b from-[#2A0611] via-[#22050E] to-[#1A030A] border border-white/10 p-5 sm:p-10 lg:p-12 text-left shadow-2xl">
        ...
        {/* 4 Balanced Maroon Horizontal Rounded Pill Cards with Yellow Numbers & Icons */}
        <div className="space-y-3 mb-6 sm:mb-8">
          {steps.map((step) => {
            ...
            return (
              <div
                key={step.num}
                className="flex items-center gap-4 px-5 py-3.5 rounded-2xl bg-[#2E0713]/80 border border-white/10 hover:border-[#FFD21F]/40 transition-all duration-200"
              >
        ...
        <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden border border-white/15 aspect-[4/3] group shadow-xl">
          ...
          <div className="absolute top-3 right-3 sm:top-6 sm:right-6 bg-[#24050E]/90 backdrop-blur-md px-3 py-1.5 sm:px-3.5 sm:py-2 rounded-xl sm:rounded-2xl border border-white/20 text-left shadow-xl max-w-[130px] sm:max-w-none">
